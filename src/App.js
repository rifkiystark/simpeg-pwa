...
import PresenceInUpt from "./pages/presence-in-upt/PresenceInUpt";
        ...
        <Routes>
          <Route exact path="/" element={<BaseLayout />}>
            ...
            <Route
              path="profile"
              element={
                <AuthProvider level={["admin", "adminunit", "pegawai"]}>
                  <Profile />
                </AuthProvider>
              }
            />
            ...
            />
            <Route
              path="master/structural-position"
              element={
                <AuthProvider level={["admin"]}>
                  <MasterStructuralPosition />
                </AuthProvider>
              }
            />
            <Route
              path="master/functional-position"
              element={
                <AuthProvider level={["admin"]}>
                  <MasterFunctionalPosition />
                </AuthProvider>
              }
            />
            <Route
              path="master/additional-position"
              element={
                <AuthProvider level={["admin"]}>
                  <MasterAdditionalPosition />
                </AuthProvider>
              }
            />
            <Route
