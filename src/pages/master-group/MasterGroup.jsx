                            ...
                            <form action="http://localhost/simpeglocal/pegawai/tmdiklat/edit/proses" method="post">
                                <div class="row g-3">
                                    <div class="col-md-12">
                                        ...
                                        <input type="hidden" name="kode_diklat" class="form-control" value={group.kodeGolongan} />
                                        <input type="text" name="jenis_diklat" class="form-control" value={group.pangkat} />
                                    </div>
