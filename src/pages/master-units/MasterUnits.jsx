...
import { setUnits } from "../../reduxslice/masterDataSlice";


function MasterUnits() {
    let dispatch = useDispatch();
    let units = useSelector((state) => state.masterData.units)
    const dummyUnits = {
        column: [
            {
                name: "Kode UPT",
                ...
                <div className="container-xl">
                    <div className="card">
                        ...
                        <div className="card-body">
                            <Table data={dummyUnits} tableName="Master Data UPT" />
                        </div>
                    </div>
                </div>
            </div >
                ...
                <div className="modal-dialog modal-sm modal-dialog-centered" role="document">
                    <div className="modal-content">
                        ...
                        <div className="modal-body text-center py-4">
                            ...
                            <div className="text-muted">Anda akan menghapus data upt <b>{units.upt}</b></div>
                        </div>
                ...
                <div className="modal-dialog modal-dialog-centered" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalLabel">Edit UPT</h5>
                            ...
                            <form action="http://localhost/simpeglocal/pegawai/tmdiklat/edit/proses" method="post">
                                <div className="row g-3">
                                    <div className="col-md-12">
                                        ...
                                        <input type="hidden" name="kode_diklat" className="form-control" value={units.kodeUPT} />
                                        <input type="text" name="jenis_diklat" className="form-control" value={units.upt} />
                                    </div>
