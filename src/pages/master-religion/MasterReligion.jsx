                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Edit Agama</h5>
                            ...
                            <form action="http://localhost/simpeglocal/pegawai/tmdiklat/edit/proses" method="post">
                                <div class="row g-3">
                                    <div class="col-md-12">
                                        ...
                                        <input type="hidden" name="kode_diklat" class="form-control" value={religion.id} />
                                        <input type="text" name="jenis_diklat" class="form-control" value={religion.name} />
                                    </div>
