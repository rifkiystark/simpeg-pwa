...

            {
                ...
                render: (data, index, rowData) => (<>
                    <button className="btn btn-primary btn-sm mt-1 me-1" data-bs-toggle="modal" data-bs-target="#ModalEdit" onClick={() => {
                        dispatch(setReligion({ id: rowData.kodeAgama, name: rowData.agama }))
                    }}>
                        Edit
                    </button>
                ...
                <div className="container-xl">
                    <div className="card">
                        ...
                        <div className="card-body">
                            ...
                            <Table data={dummyReligion} tableName="Master Data Agama" />
                ...
                <div className="modal-dialog modal-sm modal-dialog-centered" role="document">
                    <div className="modal-content">
                        ...
                        <div className="modal-body text-center py-4">
                            ...
                            <div className="text-muted">Anda akan menghapus data agama <b>{religion.name}</b></div>
                        </div>
                ...
                <div className="modal-dialog modal-dialog-centered" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalLabel">Edit Agama</h5>
                            ...
                            <form action="http://localhost/simpeglocal/pegawai/tmdiklat/edit/proses" method="post">
                                <div className="row g-3">
                                    <div className="col-md-12">
                                        ...
                                        <input type="hidden" name="kode_diklat" className="form-control" value={religion.id} />
                                        <input type="text" name="jenis_diklat" className="form-control" value={religion.name} />
                                    </div>
