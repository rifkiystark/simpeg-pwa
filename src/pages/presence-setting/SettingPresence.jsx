            ...
            <div className="card-body">
              <ul className="nav nav-pills mb-3">
                {presences.map((presence, index) =>
                  <li className="nav-item"><a href={`#navpills-${presence.id}`} className={`nav-link ${index === 0 ? 'active show' : ''}`} data-bs-toggle="tab" aria-expanded="false">{presence.upt}</a></li>
                )}
              </ul>
              <div className="tab-content br-n pn">
                {presences.map((presence, index) =>
                  <div id={`navpills-${presence.id}`} className={`tab-pane ${index === 0 ? 'active show' : ''}`}>
                    <form action="{{url('/')}}/presensi/setting/simpan" method="POST" enctype="multipart/form-data">
                      ...
                      <div className="row">
                        <div className="col-md-6">
                          ...
                          <div className="input-group clockpicker">
                            <input type="time" className="form-control" name="waktu_masuk" onChange={(e) => onChange(e, index)} value={(presence.settings != null) ? presence.settings.waktu_masuk : ''} />
                          </div>
                        </div>
                        <div className="col-md-6">
                          <label className="form-label">Waktu Pulang</label>
                          <div className="input-group">
                            <input type="time" className="form-control" name="waktu_pulang" value={(presence.settings != null) ? presence.settings.waktu_pulang : ''} />
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="row">
                        <div className="col-md-6">
                          ...
                          <div className="input-group clockpicker">
                            <input className="form-control" name="latitude" onChange={(e) => onChange(e, index)} value={(presence.settings != null) ? presence.settings.latitude : ''} /> <span className="input-group-append"><span className="input-group-text"><svg xmlns="http://www.w3.org/2000/svg" className="icon" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <div className="col-md-6">
                          ...
                          <div className="input-group">
                            <input className="form-control" name="longitude" onChange={(e) => onChange(e, index)} value={(presence.settings != null) ? presence.settings.longitude : ''} /> <span className="input-group-append"><span className="input-group-text"><svg xmlns="http://www.w3.org/2000/svg" className="icon" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                              <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                              <circle cx="12" cy="11" r="3" />
                              <path d="M17.657 16.657l-4.243 4.243a2 2 0 0 1 -2.827 0l-4.244 -4.243a8 8 0 1 1 11.314 0z" />
                            </svg></span></span>
                        ...
                        <div className="col-md-6 mt-3">
                          ...
                          <div className="input-group">
                            <input className="form-control" name="radius" onChange={(e) => onChange(e, index)} value={(presence.settings != null) ? presence.settings.radius : ''} required /> <span className="input-group-append"><span className="input-group-text">meter</span></span>
                          </div>
                        </div>
                      </div>
                      <h3 className="card-title mt-3">Pengaturan Header Ekspor</h3>
                      <div className="row">
                        ...
                        <div className="col-md-12">
                          <img className="img img-fluid mt-3" src="@if($u->settings != null){{ asset('/foto').'/'.$u->settings->header}} @endif" alt="" />
                        </div>
                      ...
                      <div className="row">
                        <div className="col">
                          ...
                          <button type="submit" name="submit" className="mt-3 btn btn-primary">Simpan</button>
                        </div>
                      </div>
                    </form>
                  </div>
          ...
          <div className="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div className="modal-content">
              <div className="modal-header">
                ...
                <button type="button" className="btn-close" data-bs-dismiss="modal"><span>&times;</span>
                </button>
              </div>
              <div className="modal-body">
                <input id="pac-input" className="controls" type="text" placeholder="Cari tempat..." />
                <div id="map"></div>
              </div>
