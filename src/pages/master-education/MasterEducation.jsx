                ...
                <div className="modal-dialog modal-dialog-centered" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalLabel">Edit Pendidikan</h5>
                            ...
                            <form action="http://localhost/simpeglocal/pegawai/tmdiklat/edit/proses" method="post">
                                <div className="row g-3">
                                    <div className="col-md-12">
                                        ...
                                        <input type="hidden" name="kode_diklat" className="form-control" value={education.kodePendidikan} />
                                        <input type="text" name="jenis_diklat" className="form-control" value={education.pendidikan} />
                                    </div>
